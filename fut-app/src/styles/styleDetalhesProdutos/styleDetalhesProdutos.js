...
export const DARK_DS = {
  ...
  discountText: '#FF6B63',
  benefitPanelBg: 'rgba(255,255,255,0.04)',
  benefitPanelBorder: 'rgba(255,255,255,0.08)',
  benefitTitle: '#F5F5F5',
  benefitSubtitle: '#B6B6B8',
  benefitText: '#D9D9DB',
  productName: '#A6A6A8',
...
export const LIGHT_DS = {
  ...
  discountText: '#D00',
  benefitPanelBg: '#FFFFFF',
  benefitPanelBorder: '#E6E6E6',
  benefitTitle: '#000',
  benefitSubtitle: '#666',
  benefitText: '#333',
  productName: '#666',
...
export const makeStyles = (DS) =>
  StyleSheet.create({
    ...
    singlePriceRow: { marginBottom: 12 },
    pricingBlock: { marginBottom: 24, padding: 16, borderRadius: 18, backgroundColor: DS.benefitPanelBg, borderWidth: 1, borderColor: DS.benefitPanelBorder },
    pricingRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 },
    pricingLabel: { fontSize: scaleFont(13), color: DS.benefitSubtitle, fontWeight: '500' },
    pricingValueMuted: { fontSize: scaleFont(14), color: DS.oldPrice, textDecorationLine: 'line-through', fontWeight: '700' },
    pricingValue: { fontSize: scaleFont(15), color: DS.benefitTitle, fontWeight: '800' },
    economyText: { fontSize: scaleFont(14), color: DS.discountText, fontWeight: '800' },
    discountRow: { flexDirection: 'row', justifyContent: 'flex-end', marginTop: 2 },
    pricePanel: { marginBottom: 24, padding: 16, borderRadius: 18, backgroundColor: DS.benefitPanelBg, borderWidth: 1, borderColor: DS.benefitPanelBorder },
    pricePanelHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 },
    pricePanelTitle: { fontSize: scaleFont(15), fontWeight: '700', color: DS.benefitTitle },
    pricePanelBadge: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 999, backgroundColor: DS.discountBadgeBg },
    pricePanelBadgeText: { color: DS.discountText, fontWeight: '700', fontSize: scaleFont(11) },
    pricePanelList: { gap: 8 },
    pricePanelRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    pricePanelLabel: { fontSize: scaleFont(13), color: DS.benefitSubtitle, fontWeight: '500' },
    pricePanelOriginal: { fontSize: scaleFont(14), color: DS.oldPrice, textDecorationLine: 'line-through', fontWeight: '700' },
    pricePanelFinal: { fontSize: scaleFont(15), color: DS.benefitTitle, fontWeight: '800' },
    pricePanelEconomy: { fontSize: scaleFont(14), color: DS.discountText, fontWeight: '800' },
    benefitPanel: { marginBottom: 24, padding: 16, borderRadius: 18, backgroundColor: DS.benefitPanelBg, borderWidth: 1, borderColor: DS.benefitPanelBorder },
    benefitTitle: { fontSize: scaleFont(15), fontWeight: '700', color: DS.benefitTitle, marginBottom: 4 },
    benefitSubtitle: { fontSize: scaleFont(13), color: DS.benefitSubtitle, marginBottom: 12 },
    benefitList: { gap: 8 },
    benefitRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
    benefitText: { flex: 1, fontSize: scaleFont(13), color: DS.benefitText, lineHeight: scaleFont(18) },
    productName: { fontSize: scaleFont(16), color: DS.productName, marginBottom: 20 },
    sizeGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'flex-start', alignItems: 'flex-start', width: '100%', marginBottom: 30, gap: 12 },
    sizeLabelTitle: { fontSize: scaleFont(16), fontWeight: '700', color: DS.sizeLabelTitle, marginBottom: 10, width: '100%' },
    sizeBox: {
      flexBasis: width >= 420 ? '22%' : width >= 360 ? '31%' : '48%',
      flexGrow: 1,
      flexShrink: 1,
      minWidth: 68,
      height: 50,
      backgroundColor: DS.sizeBoxBg,
      borderRadius: 12,
      justifyContent: 'center',
      alignItems: 'center',
      borderWidth: 1,
      borderColor: DS.sizeBoxBorder,
    },
