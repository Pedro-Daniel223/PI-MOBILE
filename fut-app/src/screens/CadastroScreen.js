          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerContent}>
              <Text style={styles.headerTitle}>
                AQUI COMEÇA TUDO PARA VOCÊ!
              </Text>
              <Text style={styles.headerSubtitle}>
                Crie sua conta para desbloquear o conteúdo exclusivo
              </Text>
            </View>
          </View>
          ...
          <View style={styles.card}>
            ...
            <View style={localStyles.progressSection}>
                    ...
                    <React.Fragment key={meta.key}>
                      ...
                      >
                        <Ionicons
                          ...
                          size={14}
                          color={
                            isActive || isDone ? "#fff" : "rgba(10,10,10,0.40)"
                          }
                        />
                      </View>
              ...
              <View style={localStyles.progressTrack}>
                <Animated.View
                  style={[localStyles.progressFill, { width: progressWidth }]}
                >
                  <LinearGradient
            ...
            >
              {step === 1 && (
                <>
                      ...
                      return (
                        <TouchableOpacity
                          ...
                          style={[
                            ...
                            Platform.OS === "android" &&
                              localStyles.sexoChipAndroid,
                            isSelected && localStyles.sexoChipActive,
                            isSelected &&
                              Platform.OS === "android" &&
                              localStyles.sexoChipActiveAndroid,
                          ]}
                          onPress={() => {
                            setSexo(option);
                            clearError("sexo");
                        ...
                        >
                          ...
                          <Text
                            style={[
                              ...
                              Platform.OS === "android" &&
                                localStyles.sexoChipTextAndroid,
                              isSelected && localStyles.sexoChipTextActive,
                              isSelected &&
                                Platform.OS === "android" &&
                                localStyles.sexoChipTextActiveAndroid,
                            ]}
                          >
                            {option}
                          </Text>
                  ...
                  {!!errors.sexo && (
                    <Text style={localStyles.errorText}>{errors.sexo}</Text>
                  )}
                  ...
                  <CustomInput
                    ...
                    style={[
                      styles.inputStyle,
                      errors.nome && localStyles.inputErrorBorder,
                    ]}
                  />
                  {!!errors.nome && (
                    <Text style={localStyles.errorText}>{errors.nome}</Text>
                  )}
                  ...
                  <CustomInput
                    ...
                    style={[
                      styles.inputStyle,
                      errors.sobrenome && localStyles.inputErrorBorder,
                    ]}
                  />
                  {!!errors.sobrenome && (
              ...
              {step === 2 && (
                <>
                  ...
                  <CustomInput
                    ...
                    style={[
                      styles.inputStyle,
                      errors.email && localStyles.inputErrorBorder,
                    ]}
                    rightComponent={
                      isValidEmail(email) ? (
                  ...
                  <CustomInput
                    ...
                    style={[
                      styles.inputStyle,
                      errors.cpf && localStyles.inputErrorBorder,
                    ]}
                  />
                  {!!errors.cpf && (
                    <Text style={localStyles.errorText}>{errors.cpf}</Text>
                  )}
                  ...
                  <CustomInput
                    ...
                    style={[
                      styles.inputStyle,
                      errors.telefone && localStyles.inputErrorBorder,
                    ]}
                  />
                  {!!errors.telefone && (
                    <Text style={localStyles.errorText}>{errors.telefone}</Text>
                  )}
                  ...
                  <CustomInput
                    ...
                    style={[
                      styles.inputStyle,
                      errors.senha && localStyles.inputErrorBorder,
                    ]}
                    rightComponent={
                      <TouchableOpacity
                  ...
                  />
                  {!!errors.senha && (
                    <Text style={localStyles.errorText}>{errors.senha}</Text>
                  )}
                  ...
                  <CustomInput
                    ...
                    style={[
                      styles.inputStyle,
                      errors.confirm && localStyles.inputErrorBorder,
                    ]}
                    rightComponent={
                      <TouchableOpacity
                  ...
                  />
                  {!!errors.confirm && (
                    <Text style={localStyles.errorText}>{errors.confirm}</Text>
                  )}
                </>
              )}
              ...
              {step === 3 && (
                <>
                  <Text style={localStyles.optionalHint}>
              ...
              {step > 1 && (
                <TouchableOpacity
                  style={[
                    ...
                    Platform.OS === "android" &&
                      localStyles.backStepButtonAndroid,
                  ]}
                ...
                >
                  ...
                  <Text
                    style={[
                      ...
                      Platform.OS === "android" &&
                        localStyles.backStepButtonTextAndroid,
                    ]}
                  >
                    Voltar
                  </Text>
